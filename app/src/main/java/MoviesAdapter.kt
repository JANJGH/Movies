...
package com.example.hpp
    ...
    import com.example.movies.databinding.CostumToastBinding
    import com.example.movies.databinding.ItemsMoviesBinding


    class MoviesAdapter(private val movies: List<Movie.Movies>) : RecyclerView.Adapter<MoviesAdapter.UserViewHolder>() {
    ...
    fun Context.showCustomToast(message: String) {
        ...
        val binding = CostumToastBinding.inflate(inflater)
